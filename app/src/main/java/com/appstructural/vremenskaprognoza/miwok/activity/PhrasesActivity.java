...
import com.appstructural.vremenskaprognoza.miwok.customAdapter.WordAdapter;
...
public class PhrasesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        words.add(new Word("Wher are you going","minto wuksus",R.raw.phrase_where_are_you_going));
        words.add(new Word("What is your name","tinna`oyasse`na",R.raw.phrase_what_is_your_name));
        ...
        words.add(new Word("Are u coming?","hәә’әәnәm?",R.raw.phrase_are_you_coming));
